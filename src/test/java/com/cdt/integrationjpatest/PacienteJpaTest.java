...
public class PacienteJpaTest {
    ...
    void setUp() {
        ...
        //When
        newPacienteEntity = repository.save(pacienteEntity);
    }
    ...
    void savePacienteTest() {
        ...
        //When
        Paciente newPacientEntity = repository.save(pacienteEntity);
    ...
    void findAllPacienteTest() {
        ...
        // When
        List<Paciente> listPacientes = repository.findAll();
    ...
    void findByIdPacienteTest() {
        ...
        // When
        Optional<Paciente> pacienteEntity = repository.findById(newPacienteEntity.getId());
    ...
    void updatePacientTest() {
        ...
        //When
        Paciente updatedPacientEntity = repository.save(newPacienteEntity);
    ...
    void deletePacientTest() {
        ...
        // When
        repository.delete(newPacienteEntity);

        // Then
        assertThrows(NoSuchElementException.class, () -> {
            repository.findById(newPacienteEntity.getId()).orElseThrow();
        });
    }
